  ...
  (define processing-parser
    (parser
      ...
      (grammar
        ...
        (literal
          [(int-lit)            (make-todo 1)]
          [(long-lit)           (make-todo 1)]
          [(float-lit)          (make-todo 1)] 
          [(double-lit)         (make-todo 1)] 
          [(boolean-lit)        (make-todo 1)] 
          [(string-lit)         (make-todo 1)] 
          [(char-lit)           (make-todo 1)] 
          [(null-lit)           (make-todo 1)])
        ...
        (array-type
          [(primitive-type dims)   (make-todo 1)]
          [(name dims)             (make-todo 1)])
        ...
        (compilation-unit
          [(package-declaration import-declarations type-declarations)
           (make-todo 1)]
          [(import-declarations type-declarations) (make-todo 1)]
          [(package-declaration type-declarations) (make-todo 1)]
          [(package-declaration import-declarations) (make-todo 1)]
          [(package-declaration) (make-todo 1)]
          [(import-declarations) (make-todo 1)]
          [(type-declarations) (make-todo 1)]
          [() (make-todo 1)])

        (import-declarations
          [(import-declaration) (list $1)]
          [(import-declarations import-declaration) (make-todo 1)])

        (type-declarations
          [(type-declaration) (list $1)]
          [(type-declarations type-declaration) (make-todo 1)])
        ...
        (modifier
          [(public)        (make-todo 1)]
          [(protected)     (make-todo 1)]
          [(private)       (make-todo 1)]
          [(static)        (make-todo 1)]
          [(abstract)      (make-todo 1)]
          [(final)         (make-todo 1)]
          [(strictfp)      (make-todo 1)]
          [(native)        (make-todo 1)]
          [(synchronized)  (make-todo 1)]
          [(transient)     (make-todo 1)]
          [(volatile)      (make-todo 1)])
        ...
        ;; Methods
        (method-declaration
          [(method-header method-body) (make-todo 1)])

        (method-header
          [(modifiers type method-declarator throws) (make-todo 1)]
          [(modifiers void method-declarator throws)
           (make-todo 1)]
          [(type method-declarator throws) (make-todo 1)]
          [(void method-declarator throws)
           (make-todo 1)])

        (method-declarator
          [(identifier l-paren formal-parameter-list r-paren) (list (make-todo
                                                                      1))]
          [(identifier l-paren r-paren) (list (make-todo 1))]
          [(identifier l-paren formal-parameter-list r-paren dims) (list (make-todo 1))]
          [(identifier l-paren r-paren dims) (list (make-todo 1))])
        ...
        (formal-parameter
          [(type var-declarator-id) (make-todo 1)]
          [(final type var-declarator-id) (make-todo 1)])
        ...
        (constructor-declarator
          [(identifier l-paren formal-parameter-list r-paren) (list (make-todo 1))]
          [(identifier l-paren r-paren) (list (make-todo 1))])
        ...
        ;; Array Initializer
        (array-initializer
          [(l-sbrack var-initializers comma r-sbrack)   (make-todo 1)]
          [(l-sbrack var-initializers r-sbrack)         (make-todo 1)]
          [(l-sbrack comma r-sbrack)                    (make-todo 1)]
          [(l-sbrack r-sbrack)                          (make-todo 1)])
        ...
        ;; Blocks
        (block
          [(l-cbrack block-stmts r-cbrack)  (make-todo (reverse $2) )]
          [(l-cbrack r-cbrack)              (make-todo null )])
      ...
      (local-var-decl
        [(type var-declarators) (make-todo 1)])
      ...
      (empty-stmt
        [(semicolon) (make-todo null)])

      (labeled-stmt
        [(identifier : stmt) (make-todo 1)])

      (labeled-stmt-no-short-if
        [(identifier : stmt-no-short-if) (make-todo 1)])
      ...
      (switch-block-stmt-group
        [(switch-labels block-stmts) (make-todo 1)])
      ...
      (break-stmt
        [(break identifier semicolon) (make-todo 1)]
        [(break semicolon) (make-todo 1)])

      (continue-stmt
        [(continue identifier semicolon) (make-todo 1)]
        [(continue semicolon) (make-todo 1)])

      (return-stmt
        [(return expr semicolon) (make-todo 1)]
        [(return semicolon) (make-todo 1)])

      (throw-stmt
        [(throw expr semicolon) (make-todo 1)])
      ...
      (try-stmt
        [(try block catches) (make-todo 1)]
        [(try block catches finally-stmt) (make-todo 1)]
        [(try block finally-stmt) (make-todo 1)])
      ...
      (primary-no-new-array
        ...
        [(method-invocation) $1]
        [(array-access) $1]
        [(primitive-type period class) (make-todo 1)]
        [(name period class) (make-todo 1)]
        [(void period class) (make-todo 1)]
        [(name period this) (make-todo 1)])
      ...
      (array-creation-expr
        [(new primitive-type dim-exprs dims) (make-todo 1)]
        [(new primitive-type dim-exprs) (make-todo 1)]
        [(new class-or-interface-type dim-exprs dims)
         (make-todo 1)]
        [(new class-or-interface-type dim-exprs)
         (make-todo 1)]
        [(new primitive-type dims array-initializer) (make-todo 1)]
      ...
      (field-access
        [(primary period identifier)    (make-todo 1)]
        [(super period identifier)     (make-todo 1)]
        [(name period super period identifier) (make-todo 1)])

      (method-invocation
        [(name l-paren args r-paren) (make-todo 1)]
        [(name l-paren r-paren) (make-todo 1)]
