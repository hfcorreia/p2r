...
(provide parse-processing parse-processing-repl)
...
(define (parse-processing src input-port)
  ...
  (file-path src)
  ((processing-parser src #t) (lambda () (lex input-port))))

(define (parse-processing-repl src input-port)
  ;; turns on line and column location for input-port
  (port-count-lines! input-port)
  (file-path src)
...
;;; Parser definition
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(define (processing-parser src [repl? #f])
  (define parser-list
    (parser
      (src-pos)
      (start <compilation-unit> <repl-unit>)
      (end EOF)
      ;(debug "parser.debug")
      ...
      (grammar
        ...
        (<repl-unit>
          [(<compilation-unit>)
           (make-object repl-unit% (send $1 get-ast) (build-src 1))]
          [(<expr>)
           (make-object repl-unit% (list $1) (build-src 1))])
        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ;; Global
        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        (<global-declarations>
